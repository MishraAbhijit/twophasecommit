...
public class TransactionServiceImpl implements TransactionService {
    ...
    public ResponseEntity<String> paceOrder(OrderRequest orderRequest) {
        ...
        try {
            ...
            ResponseEntity<String> orderPrep = restTemplate.postForEntity("http://localhost:8081/order/prepare", orderRequest, String.class);
            ...
            if (inventoryPrep.getStatusCode().is2xxSuccessful() && paymentPrep.getStatusCode().is2xxSuccessful() && orderPrep.getStatusCode().is2xxSuccessful()) {
                ...
                restTemplate.postForEntity("http://localhost:8081/order/commit", orderRequest, String.class);
            ...
            restTemplate.postForEntity("http://localhost:8081/order/rollback", orderRequest, String.class);
